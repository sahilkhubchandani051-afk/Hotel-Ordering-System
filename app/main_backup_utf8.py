...
if os.path.exists(TEMPLATES_PATH):
    ...
    print(f"âš ï¸ WARNING: Templates directory NOT FOUND!")
print(f"=" * 60)
...
def calculate_next_delivery_date(po_created_at: datetime, delivery_days: list) -> str:
    ...
    Logic:
        ...
        - If PO created on delivery day, check time:
          - Before cutoff (e.g., 10 AM) â†’ same day
          - After cutoff â†’ next delivery day
    """
...
def apply_migrations():
    ...
    if get_setting('migrations_applied') == 'v10':
        conn.close()
        return
    ...
    try:
        ...
        set_setting('migrations_applied', 'v10')
    except Exception as e:
...
def get_current_delivery_stage(po, current_datetime=None):
    ...
    if current_date >= D:
        ...
        # At least 1 day after order â†’ PACKAGED
...
async def edit_product(request: Request, product_id: int):
    ...
    try:
        ...
        conn.execute("UPDATE products SET name=?, name_marathi=?, unit=?, rate=?, category_id=?, image_url=? WHERE id=?", 
                    (name, name_marathi, unit, rate, category_id, image_url, product_id))
        conn.commit()
        conn.close()
    ...
    for item in items:
        ...
        if prod:
            hydrated_items.append({
                ...
                "qty": item['qty'],
                "unit": prod['unit'],
                "suggested_rate": prod['rate'] # Admin can edit this
            })
...
async def submit_quotation(request: Request, pr_id: int):
    ...
    try:
        ...
        subject = f"ðŸ“„ New Quotation Received for PR #{pr_id}"
        message = f"""
<html>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 20px auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #ffffff;">
        ...
        <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #2c3e50; margin: 0; font-size: 24px;">ðŸ“„ New Quotation Received</h1>
        ...
        <div style="background-color: #e3f2fd; padding: 20px; border-radius: 6px; margin: 20px 0; border-left: 4px solid #2196f3;">
            <h3 style="color: #1565c0; margin: 0 0 15px 0; font-size: 16px;">ðŸ¢ Supplier Details</h3>
        ...
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 6px; margin: 20px 0; border-left: 4px solid #007bff;">
            <h3 style="color: #2c3e50; margin: 0 0 15px 0; font-size: 16px;">ðŸ“‹ Quotation Received</h3>
...
async def customer_invoices(
    ...
    query = "SELECT *, delivery_status, tracking_status FROM purchase_orders WHERE customer_email = ? AND is_active = 1"
    params = [user["email"]]
...
async def customer_statement(
    ...
    for po in all_pos:
        ...
        inv_rec = po.get('invoice_receipt', 0.0) or 0.0
...
async def submit_draft_pr(request: Request, pr_id: int):
    ...
    try:
        ...
        subject = f"ðŸ”” New Purchase Request from {customer_name or 'Customer'}"
        body = f"""
<html>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 20px auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #ffffff;">
        ...
        <!-- Header -->
        <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #2c3e50; margin: 0; font-size: 24px;">ðŸ›’ New Purchase Request</h1>
        ...
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 6px; margin: 20px 0; border-left: 4px solid #3498db;">
            <h3 style="color: #2c3e50; margin: 0 0 15px 0; font-size: 16px;">ðŸ“‹ Customer Details</h3>
        ...
        <div style="background-color: #fff3cd; padding: 20px; border-radius: 6px; margin: 20px 0; border-left: 4px solid #ffc107;">
            <h3 style="color: #856404; margin: 0 0 15px 0; font-size: 16px;">âš¡ Action Required</h3>
    ...
    if po and pr['status'] in ['ACCEPTED', 'PARTIALLY_ACCEPTED']:
        delivery_data = {
            ...
            'stages': {
                ...
                'SHIPPED': {
                    'label': 'Shipped',
                    'timestamp': po.get('shipped_at'),
                    'completed': bool(po.get('shipped_at'))
                },
                'OUT_FOR_DELIVERY': {
    ...
    try:
        ...
        if accepted_count > 0:
            ...
            if new_status == 'ACCEPTED':
                subject = f"âœ… Quotation Accepted by {customer_name}"
                message = f"""
<html>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 20px auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #ffffff;">
        ...
        <!-- Header -->
        <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #27ae60; margin: 0; font-size: 24px;">âœ… Quotation Accepted</h1>
        ...
        <div style="background-color: #d4edda; padding: 20px; border-radius: 6px; margin: 20px 0; border-left: 4px solid #28a745;">
            <h3 style="color: #155724; margin: 0 0 15px 0; font-size: 16px;">ðŸ“‹ Acceptance Details</h3>
            <p style="margin: 8px 0;"><strong>Customer Name:</strong> {customer_name or 'N/A'}</p>
            <p style="margin: 8px 0;"><strong>PR Number:</strong> #{pr_id}</p>
        ...
        <!-- Action Required -->
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 6px; margin: 20px 0; border-left: 4px solid #007bff;">
            <h3 style="color: #2c3e50; margin: 0 0 15px 0; font-size: 16px;">ðŸŽ‰ Congratulations!</h3>
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; text-align: center;">
            ...
            <p style="color: #6c757d; margin: 5px 0; font-size: 12px;">This is an automated message. Please do not reply to this email.</p>
                ...
                subject = f"âŒ Quotation Rejected by {customer_name}"
                message = f"""
<html>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 20px auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #ffffff;">
        ...
        <!-- Header -->
        <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #dc3545; margin: 0; font-size: 24px;">âŒ Quotation Rejected</h1>
        ...
        <div style="background-color: #f8d7da; padding: 20px; border-radius: 6px; margin: 20px 0; border-left: 4px solid #dc3545;">
            <h3 style="color: #721c24; margin: 0 0 15px 0; font-size: 16px;">ðŸ“‹ Rejection Details</h3>
            <p style="margin: 8px 0;"><strong>Customer Name:</strong> {customer_name or 'N/A'}</p>
            <p style="margin: 8px 0;"><strong>PR Number:</strong> #{pr_id}</p>
        ...
        <!-- Action Required -->
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 6px; margin: 20px 0; border-left: 4px solid #007bff;">
            <h3 style="color: #2c3e50; margin: 0 0 15px 0; font-size: 16px;">ðŸ“ Status Update</h3>
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; text-align: center;">
            ...
            <p style="color: #6c757d; margin: 5px 0; font-size: 12px;">This is an automated message. Please do not reply to this email.</p>
                ...
                subject = f"âš ï¸ Quotation Partially Accepted by {customer_name}"
                message = f"""
<html>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 20px auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #ffffff;">
        ...
        <!-- Header -->
        <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #ffc107; margin: 0; font-size: 24px;">âš ï¸ Quotation Partially Accepted</h1>
            <p style="color: #7f8c8d; margin: 5px 0 0 0; font-size: 14px;">PR #{pr_id} - Action Required</p>
        </div>
        
        <!-- Customer Information -->
        <div style="background-color: #fff3cd; padding: 20px; border-radius: 6px; margin: 20px 0; border-left: 4px solid #ffc107;">
            <h3 style="color: #856404; margin: 0 0 15px 0; font-size: 16px;">ðŸ“‹ Partial Acceptance Details</h3>
            <p style="margin: 8px 0;"><strong>Customer Name:</strong> {customer_name or 'N/A'}</p>
            <p style="margin: 8px 0;"><strong>PR Number:</strong> #{pr_id}</p>
        ...
        <!-- Action Required -->
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 6px; margin: 20px 0; border-left: 4px solid #007bff;">
            <h3 style="color: #2c3e50; margin: 0 0 15px 0; font-size: 16px;">ðŸ“‹ Partial Acceptance Explained</h3>
...
async def update_order_tracking(request: Request, po_id: int):
    ...
    try:
        ...
        print(f"[DEBUG] Tracking status updated for PO #{po_id}: {po['tracking_status']} â†’ {new_tracking_status}")
